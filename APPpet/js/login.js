    ...
    $.ajax({
        ...
        success:function (e) {
            ...
            if(e=='1'){
                ...
                setTextToNoAlert('alert btn-success text-center','Sucesso!');
                setTimeout("window.location.href='administrativo.php'", 3000);
            }
            else if(e=='2'){
                console.log('erro 2');
                setTextToNoAlert('alert btn-danger text-center','Erro no Login! Senha');
                ...
                console.log('erro 4');
                setTextToNoAlert('alert btn-danger text-center','Erro no Login! Usuário');
                ...
                console.log('erro 3');
                setTextToNoAlert('alert btn-danger text-center','Erro no Login!');
...
function setTextToNoAlert(classe, message) {
